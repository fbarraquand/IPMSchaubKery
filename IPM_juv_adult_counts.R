...
boxplot(cbind(res1[1,1,], res2[1,1,], res3[1,1,], res4[1,1,]),
...
boxplot(cbind(res1[1,2,], res2[1,2,], res3[1,2,], res4[1,2,]),
        ylab=lab, outline=FALSE, names=NA,
        col=c("red", "dodgerblue", "darkolivegreen", "orange"), axes=FALSE)
axis(1, labels=NA)
axis(2)
...
boxplot(cbind(res1[2,1,], res2[2,1,], res3[2,1,], res4[2,1,]),
        ylab=lab, outline=FALSE, names=NA,
        col=c("red", "dodgerblue", "darkolivegreen", "orange"), axes=FALSE)
abline(h=sa, lty=2)
axis(1, labels=NA)
...
boxplot(cbind(res1[2,2,], res2[2,2,], res3[2,2,], res4[2,2,]),
        ylab=lab, outline=FALSE, names=NA,
        col=c("red", "dodgerblue", "darkolivegreen", "orange"), axes=FALSE)
axis(1, labels=NA)
axis(2)
...
boxplot(cbind(res1[4,1,], res2[4,1,], res3[4,1,], res4[4,1,]),
        ylab=lab, outline=FALSE, names=NA,
        col=c("red", "dodgerblue", "darkolivegreen", "orange"), axes=FALSE)
abline(h=fl1, lty=2)
axis(1, labels=NA)
...
boxplot(cbind(res1[4,2,], res2[4,2,], res3[4,2,], res4[4,2,]),
        ylab=lab, outline=FALSE, names=NA,
        col=c("red", "dodgerblue", "darkolivegreen", "orange"), axes=FALSE)
axis(1, labels=NA)
axis(2)
