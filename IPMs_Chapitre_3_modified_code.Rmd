...
sj <- 0.55      # Juvenile survival
sa <- 0.3     # Adult survival
f1 <- 1.8      # Number of female fledglings per 1-year old female and year
fa <- 1.3      # Number of female fledglings per adult female and year
...
```
Pour ces modèles, il n'y a pas vraiment d'utilité à utiliser les MCMC.
Inits=NULL permet à JAGS de générer les valeurs lui-même.
```{r}
library(IPMbook) ; library(jagsUI)
